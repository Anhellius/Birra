...
<div class="">
              ...
              <ul class="orbit-container">
                <li class="orbit-slide">
                  <figure class="orbit-figure">
                    ...
                    <img class="cropcontainer" src="img/notas/nota-10.jpg" alt="image alt text">
                    <figcaption class="orbit-caption">
                      <h3 class="robotoMono-light">Lorem Ipsum Etiam</h3>
                      <p class="roboto-light">Etiam porta sem malesuada magna mollis euismod. Vestibulum id ligula porta felis euismod semper.</p>
                      <div class="grid-x">
                        <div class="cell small-12 large-shrink"><a href="noticia.html" class="button rounded expanded deep-orange darken-1">Mattis Elit</a></div>
                      </div>
          ...
          <div class="orbit clean-hero-slider" role="region" aria-label="Favorite Space Pictures" data-orbit>
            <div class="orbit-wrapper">
              ...
              <ul class="orbit-container">
                ...
                <li class="orbit-slide">
                  <figure class="orbit-figure">
                    <img class="cropcontainer" src="img/notas/nota-1.jpg" alt="image alt text">
                    <figcaption class="orbit-caption">
                      <h3 class="h4  robotoMono-light">Lorem Ipsum Etiam</h3>
                      <p class="roboto-light">Etiam porta sem malesuada magna mollis euismod. Vestibulum id ligula porta felis euismod semper.</p>
                      <a href="noticia2.html" class="button rounded  deep-orange darken-1">Mattis Elit</a>
                    </figcaption>
                  </figure>
                </li>
                <li class="orbit-slide">
                  <figure class="orbit-figure">
                    <img class="cropcontainer" src="img/notas/nota-2.jpg" alt="image alt text">
                    <figcaption class="orbit-caption">
                      <h3 class="h4 robotoMono-light">Ipsum Ornare Ultricies</h3>
                      <p class="roboto-light">Nullam quis risus eget urna mollis ornare vel eu leo. Donec ullamcorper nulla non metus auctor fringilla. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                      <a href="#" class="button rounded  deep-orange darken-1">Egestas Amet</a>
                    </figcaption>
                  </figure>
                </li>
                <li class="orbit-slide">
                  <figure class="orbit-figure">
                    <img class="cropcontainer" src="img/notas/nota-3.jpg" alt="image alt text">
                    <figcaption class="orbit-caption">
                      <h3 class="h4 robotoMono-light">Malesuada Parturient</h3>
                      ...
                      <a href="#" class="button rounded  deep-orange darken-1">Sollicitudin</a>
                    </figcaption>
                  </figure>
                </li>
              </ul>
        ...
        <div class="cell small-12 large-8">
          ...
          <div class="grid-x grid-margin-x">
            ...
            <div class="cell large-auto">
              <h5 class=" roboto-light">Dónde Ir</h5>
              <ul class="no-bullet">
                <li class="size-14">
                  <a href="">ON TAP </a>
                  <a href=""><i class="fa fa-facebook" aria-hidden="true"></i></a>
                  <a href=""><i class="fa fa-map-marker" aria-hidden="true"></i></a></li>
                <li class="size-14">CERVELAR </li>
                <li class="size-14">BÉLGICA </li>
                <li class="size-14">BIERLIFE </li>
              </ul>
            </div>
            <!--fin donde ir-->
            ...
            <!--que tomar-->
            <div class="cell large-auto">
              <h5 class=" roboto-light">Que tomar</h5>
              <ul class="no-bullet">
                <li class="size-14">
                  <a href="">JUGUETES PERDIDOS </a>
                  <a href=""><i class="fa fa-facebook" aria-hidden="true"></i></a>
                  <a href=""><i class="fa fa-map-marker" aria-hidden="true"></i></a></li>
                <li class="size-14">BERLINA  </li>
                <li class="size-14">LA HORMIGA NEGRA  </li>
              </ul>
            </div>
            <!--fin que tomar-->
            ...
            <!--insumos-->
            <div class="cell large-auto">
              <h5 class=" roboto-light">Insumos</h5>
              <ul class="no-bullet">
                <li class="size-14">
                  <a href="">MINICERVECERÍA</a>
                  <a href=""><i class="fa fa-facebook" aria-hidden="true"></i></a>
                  <a href=""><i class="fa fa-map-marker" aria-hidden="true"></i></a></li>
                <li class="size-14">CENTRAL BIER</li>
                <li class="size-14">BROWER INSUMOS</li>
                <li class="size-14">CARGILL</li>
                <li class="size-14">MALTERÍA PAMPA SA </li>
              </ul>
            </div>
            <!--fin insumos-->
            ...
            <div class="cell large-auto">
              <h5 class=" roboto-light">Alquileres de choperas</h5>
              <ul class="no-bullet">
                <li class="size-14">
                  <a href="">CERVEZA ARTESANAL ALLEGRA</a>
                  <a href=""><i class="fa fa-facebook" aria-hidden="true"></i></a>
                  <a href=""><i class="fa fa-map-marker" aria-hidden="true"></i></a></li>
                <li class="size-14">Cerveceria Heberling  </li>
                <li class="size-14">Cerveza Artesanal Morante </li>
              </ul>
            </div>
                  ...
                  <ul class="orbit-container">
                    <li class="is-active orbit-slide black">
                      <figure class="orbit-figure">
                        ...
                        <img class="orbit-image cropcontainer" src="img/notas/nota-4.jpg" alt="image alt text">
                        <figcaption class="orbit-caption">
                          <h4 class="robotoMono-light">Lorem Ipsum Etiam</h4>
                          <p>Etiam porta sem malesuada magna mollis euismod. Vestibulum id ligula porta felis euismod semper.</p>
                          <a href="#" class="button rounded deep-orange darken-1">Mattis Elit</a>
                        </figcaption>
                      </figure>
                    </li>
                  </ul>
                  ...
                  <ul class="orbit-container">
                    <li class="is-active orbit-slide black">
                      <figure class="orbit-figure">
                        ...
                        <img class="orbit-image cropcontainer" src="img/notas/nota-5.jpg" alt="image alt text">
                        <figcaption class="orbit-caption">
                          <h4 class="robotoMono-light">Lorem Ipsum Etiam</h4>
                          <p>Etiam porta sem malesuada magna mollis euismod. Vestibulum id ligula porta felis euismod semper.</p>
                          <a href="#" class="button rounded deep-orange darken-1">Mattis Elit</a>
                  ...
                  <ul class="orbit-container">
                    <li class="is-active orbit-slide black">
                      <figure class="orbit-figure">
                        ...
                        <img class="orbit-image cropcontainer" src="img/notas/nota-6.jpg" alt="image alt text">
                        <figcaption class="orbit-caption">
                          <h4 class="robotoMono-light">Lorem Ipsum Etiam</h4>
                          <p>Etiam porta sem malesuada magna mollis euismod. Vestibulum id ligula porta felis euismod semper.</p>
                          <a href="#" class="button rounded deep-orange darken-1">Mattis Elit</a>
              ...
              <ul class="orbit-container">
                <li class="is-active orbit-slide black">
                  <figure class="orbit-figure">
                    ...
                    <img class="orbit-image cropcontainer" src="img/notas/nota-7.jpg" alt="image alt text">
                    <figcaption class="orbit-caption">
                      <h4 class="robotoMono-light">Lorem Ipsum Etiam</h4>
                      <p>Etiam porta sem malesuada magna mollis euismod. Vestibulum id ligula porta felis euismod semper.</p>
                      <a href="#" class="button rounded deep-orange darken-1">Mattis Elit</a>
              ...
              <ul class="orbit-container">
                <li class="is-active orbit-slide black">
                  <figure class="orbit-figure">
                    ...
                    <img class="orbit-image cropcontainer" src="img/notas/nota-8.jpg" alt="image alt text">
                    <figcaption class="orbit-caption">
                      <h4 class="robotoMono-light">Lorem Ipsum Etiam</h4>
                      <p>Etiam porta sem malesuada magna mollis euismod. Vestibulum id ligula porta felis euismod semper.</p>
                      <a href="#" class="button rounded deep-orange darken-1">Mattis Elit</a>
  ...
  <footer class="grid-x grid-padding-x grid-padding-y align-justify blue-grey darken-4 white-text">
      ...
      <div class="cell small-12 large-6">
        ...
        <ul class="no-bullet">
          <li class="size-14">
            ...
            <a href=""><i class="fa fa-facebook" aria-hidden="true"></i></a>
            <a href=""><i class="fa fa-map-marker" aria-hidden="true"></i></a></li>
          <li class="size-14">CENTRO CATA DE CERVEZA</li>
          <li class="size-14">MINICERVECERIA</li>
          <li class="size-14">CENTRAL BIER </li>
        </ul>
      </div>
      ...
      <!--camaras sectoriales-->
      <div class="cell small-12 large-6">
        <h5 class=" roboto-light">Cámaras sectoriales</h5>
        <ul class="no-bullet">
          <li class="size-14">
            <a href="">Cámara Argentina de Productores de Cerveza Artesanal </a>
            <a href=""><i class="fa fa-facebook" aria-hidden="true"></i></a>
            <a href=""><i class="fa fa-map-marker" aria-hidden="true"></i></a></li>
          <li class="size-14">Cámara de Cerveceros Artesanales de Argentina</li>
          <li class="size-14">Cámara Santafesina de Cervecerías</li>
          <li class="size-14">Cámara de Cerveceros Artesanales de Bariloche </li>
          <li class="size-14">Asociación de Cerveceros Artesanales Platenses </li>
          <li class="size-14">Cámara de Cervecerías Artesanales de Mar del Plata </li>
          <li class="size-14">Cámara Rosarina de Cerveceros </li>
          <li class="size-14">Asociación Civil Somos Cerveceros </li>
          <li class="size-14">Cámara de Cerveceros Artesanales de Mendoza </li>
          <li class="size-14">Centro de Cata de Cerveza </li>
        </ul>
      </div>

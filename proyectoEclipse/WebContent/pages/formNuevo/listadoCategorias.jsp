...
<div class="off-canvas-wrapper">
    <div class="off-canvas-wrapper-inner" data-off-canvas-wrapper>
    	<div class="off-canvas-content" data-off-canvas-content>
		  ...
		  <input type="button" id="nuevaCategoriaNoticias" class="modalParaNuevo button expanded sombra-1 bg-color3" value="Nuevo Categoria de noticias">
		  
		  <input type="button" id="nuevaCategoriaClasificados" class="modalParaNuevo button expanded sombra-1 bg-color3" value="Nuevo Categoria de clasificados">
